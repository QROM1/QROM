...
async def _(event):
    ...
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#إعــادة_التشغيــل\n\n" "**⪼  بـوت انينمـَوس في وضـع اعـادة التشغيـل انتظـر**\n\n" "**❖ اذ لـم يستجـب البـوت بعـد خمـس دقائـق .. قـم بالذهـاب الـى حسـاب هيـروكو واعـادة التشغيـل اليـدوي**")
    zzz1 = await edit_or_reply(event, f"❖ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗧𝗛𝗢𝗡 ❖ **إعــادة التشغيــل**\n**•─────────────────•**\n**⇜ جـارِ إعـادة تشغيـل بـوت انينمـَوس  . . .❖❖**")
    await asyncio.sleep(1)
    zzz2 = await zzz1.edit("❖ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐀𝐍𝐘𝐍𝐌𝐔𝐒 ❖ **إعــادة التشغيــل**\n**•─────────────────•**\n**⇜ جـارِ إعـادة تشغيـل  بـوت انينمـَوس   . . .❖**\n\n%𝟷𝟶 ▬▭▭▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz3 = await zzz2.edit("❖ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐀𝐍𝐘𝐍𝐌𝐔𝐒 ❖ **إعــادة التشغيــل**\n**•─────────────────•**\n**⇜ جـارِ إعـادة تشغيـل  بـوت انينمـَوس   . . .❖**\n\n%𝟸𝟶 ▬▬▭▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz4 = await zzz3.edit("❖ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐀𝐍𝐘𝐍𝐌𝐔𝐒 ❖ **إعــادة التشغيــل**\n**•─────────────────•**\n**⇜ جـارِ إعـادة تشغيـل  بـوت انينمـَوس   . . .❖**\n\n%𝟹𝟶 ▬▬▬▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz5 = await zzz4.edit("❖ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐀𝐍𝐘𝐍𝐌𝐔𝐒 ❖ **إعــادة التشغيــل**\n**•─────────────────•**\n**⇜ جـارِ إعـادة تشغيـل  بـوت انينمـَوس   . . .❖**\n\n%𝟺𝟶 ▬▬▬▬▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz6 = await zzz5.edit("❖ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐀𝐍𝐘𝐍𝐌𝐔𝐒 ❖ **إعــادة التشغيــل**\n**•─────────────────•**\n**⇜ جـارِ إعـادة تشغيـل  بـوت انينمـَوس   . . .❖**\n\nn%𝟻𝟶 ▬▬▬▬▬▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz7 = await zzz6.edit("❖ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐀𝐍𝐘𝐍𝐌𝐔𝐒 ❖ **إعــادة التشغيــل**\n**•─────────────────•**\n**⇜ جـارِ إعـادة تشغيـل  بـوت انينمـَوس   . . .❖**\n\n%𝟼𝟶 ▬▬▬▬▬▬▭▭▭▭")
    await asyncio.sleep(1)
    zzz8 = await zzz7.edit("❖ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐀𝐍𝐘𝐍𝐌𝐔𝐒 ❖ **إعــادة التشغيــل**\n**•─────────────────•**\n**⇜ جـارِ إعـادة تشغيـل  بـوت انينمـَوس   . . .❖**\n\n%𝟽𝟶 ▬▬▬▬▬▬▬▭▭▭")
    await asyncio.sleep(1)
    zzz9 = await zzz8.edit("❖ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐀𝐍𝐘𝐍𝐌𝐔𝐒 ❖ **إعــادة التشغيــل**\n**•─────────────────•**\n**⇜ جـارِ إعـادة تشغيـل  بـوت انينمـَوس   . . .❖**\n\n%𝟾𝟶 ▬▬▬▬▬▬▬▬▭▭") 
    await asyncio.sleep(1)
    zzzz10 = await zzz9.edit("❖ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐀𝐍𝐘𝐍𝐌𝐔𝐒 ❖ **إعــادة التشغيــل**\n**•─────────────────•**\n**⇜ جـارِ إعـادة تشغيـل  بـوت انينمـَوس   . . .❖**\n\n%𝟿𝟶 ▬▬▬▬▬▬▬▬▬▭") 
    await asyncio.sleep(1)
    zzzz11 = await zzzz10.edit("❖ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐀𝐍𝐘𝐍𝐌𝐔𝐒 ❖ **إعــادة التشغيــل**\n**•─────────────────•**\n**⇜ جـارِ إعـادة تشغيـل  بـوت انينمـَوس   . . .❖**\n\n%𝟷𝟶𝟶 ▬▬▬▬▬▬▬▬▬▬💯") 
    sandy = await edit_or_reply(
        zzzz11,
        f"❖ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐀𝐍𝐘𝐍𝐌𝐔𝐒 ❖ **إعــادة التشغيــل**\n"
        f"**•─────────────────•**\n"
        f"**❖❖┊اهـلا عـزيـزي** - {mention}\n"
        f"**❖❖┊يتـم الان اعـادة تشغيـل  بـوت انينمـَوس **\n"
...
async def librarz(event):
    ...
    list = "ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐀𝐍𝐘𝐍𝐌𝐔𝐒 🝢 **قائمـة المكاتب المثبتـه**\n**•─────────────────•**\n"
    count = 0
    for i in installed_packages_list:
        list += f"• `{i}`\n"
        count += 1
    list += f"\n**❖ عـدد المكـاتب المثبتـه على السـورس**: `{count}`"
...
async def zeddd(event): # Code By T.me/zzzzl1l
    uname = platform.uname()
    zedt = "**- تاريخ تنصيبـك لـ  بـوت انينمـَوس  - ❖𝙎𝙊𝙐𝙍𝘾𝞝 𝐀𝐍𝐘𝐍𝐌𝐔𝐒❖**\n\n"

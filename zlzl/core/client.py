            ...
            async def wrapper(check):  # sourcery no-metrics
                if groups_only and not check.is_group:
                    return await edit_delete(
                        check, "**⪼ عذرا هذا الامر يستخدم في المجموعات فقط  ❖،**", 10
                    )
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @Mseegerorrbot\
                                  \n\n--------بـدء تتبـع سجـل الانينمـَوس 𝐀𝐍𝐘𝐍𝐌𝐔𝐒--------\
                                  \n- التـاريـخ : {date}\n- ايـدي القروب : {str(check.chat_id)}\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع الانينمـَوس 𝐀𝐍𝐘𝐍𝐌𝐔𝐒--------"
                        ...
                        link = "[مـَنظـمة الانينمـَوس ❖](https://t.me/ANENMUS)"
                        text = (
                            "**✘ تقـريـر اشعـار انينمـَوس 𝐀𝐍𝐘𝐍𝐌𝐔𝐒 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار الانينمـَوس 𝐀𝐍𝐘𝐍𝐌𝐔𝐒 ❖**\n\n "
                        link = "[مـَنظـمة الانينمـَوس ❖](https://t.me/Mseegerorrbot)"
